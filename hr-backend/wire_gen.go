...
func InitializeApp(configPath string) (*App, error) {
	...
	questionService := service.NewQuestionService(questionRepository, dimensionRepository, questionBatchRepository)
	...
	asynqGenerationEnqueuer := NewAsynqGenerationEnqueuer(asynqClient)
	questionGenerationService := service.NewQuestionGenerationService(questionGenerationRepository, dimensionRepository, questionBatchRepository, asynqGenerationEnqueuer, enabledModelProvider)
	questionGenerationHandler := handler.NewQuestionGenerationHandler(questionGenerationService, dimensionService)
	...
	engine := router.NewRouter(configConfig, manager, accountHandler, healthHandler, setupHandler, systemHandler, dimensionHandler, assessmentConfigHandler, assessmentBatchHandler, llmConfigHandler, integrationSecretHandler, questionHandler, questionBatchHandler, questionGenerationHandler, scaleHandler, client)
