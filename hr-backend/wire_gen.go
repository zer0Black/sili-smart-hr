...
func InitializeApp(configPath string) (*App, error) {
	...
	questionHandler := handler.NewQuestionHandler(questionService, dimensionService)
	engine := router.NewRouter(configConfig, manager, accountHandler, healthHandler, setupHandler, systemHandler, dimensionHandler, assessmentConfigHandler, assessmentBatchHandler, llmConfigHandler, integrationSecretHandler, questionHandler, client)
